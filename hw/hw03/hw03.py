...
def missing_digits(n):
    ...
    if n < 10:
        ...
        return missing_digits(n // 10) + countInTenDigits(n % 100)
...
def count_change(total):
    ...
    def countPartitions(n, m):
        if n == 0:
            ...
            return countPartitions(n - m, m) + countPartitions(n, m // 2)

    return countPartitions(total, biggestCoinForChange(total))
...
def make_anonymous_factorial():
    ...
    True
    """
    return (lambda f: lambda n: f(f, n, n))(lambda f, n, total: total if n == 1 else f(f, sub(n, 1), mul((n - 1), total)))
